...
$(document).ready(function() {
	...
	// Boton ir arriba
	//Creamos una función accediendo a la clase .ir-arriba en su evento click
	$('.ir-arriba').click(function(){
		$('body, html').animate({ // aplicamos la función animate a los tags body y html
			scrollTop: '0px' //al colocar el valor 0 a scrollTop me volverá a la parte inicial de la página
		}, 300); //el valor 300 indica que lo ara en 300 mili segundos
	});
	//invocamos al objeto (window) y a su método (scroll), solo se 
	//ejecutara si el usuario hace scroll en la página
	...
	if (sessionStorage.getItem("user1") !== null) {
		document.getElementById("name_user").innerHTML= [sessionStorage.getItem("nameuser")];
	};
	if (sessionStorage.getItem("story") == null) {
		$("#modalSesion").modal('show');
		sessionStorage.setItem("user1", "true");
		sessionStorage.setItem("story", "true");
	};

	/*
	$('#username').on('click', function() {
		$("#name_user").text($(this).attr('Hola'));
	});
	*/
});
